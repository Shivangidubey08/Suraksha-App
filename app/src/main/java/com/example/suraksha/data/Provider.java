...
public class Provider extends ContentProvider{
    ...
    static {
        ...
        // of the pets table.
        sUriMatcher.addURI(contractClass.CONTENT_AUTHORITY, contractClass.PATH_USERS, PETS);
        ...
        sUriMatcher.addURI(contractClass.CONTENT_AUTHORITY, contractClass.PATH_USERS + "/#", PET_ID);
    }
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the {@link UserEntry#COLUMN_PET_NAME} key is present,
